<template>
    <div class="sm:inline-flex flex-grow">
        <svg v-if="editable" @click.prevent="goToEdit" tooltip="Hello world" class="bi bi-wrench fill-current w-4 hover:bg-blue-500" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="draft" class="bi bi-pencil fill-current w-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
