<template>
  <client-only placeholder="Loading...">
    <nav class="grid grid-flow-col grid-cols-1 items-center justify-between flex-wrap p-6 bg-gray-100 sticky">
        <div class="w-1/2 flex items-center flex-shrink-0 text-gray-900 mr-6">
        ...
        <div class="block flex-grow sm:flex sm:flex-row-reverse flex-wrap justify-center sm:flex-grow-0 sm:items-center sm:w-auto">
