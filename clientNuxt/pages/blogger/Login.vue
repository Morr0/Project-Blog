<template>
  <!-- <div class="form center-align">
    ...
    <div class="row">
        <label class="active"><nuxt-link to="/blogger/register/">Don't have an account sign up</nuxt-link></label>
    </div>
  </div> -->
    <div class="w-full max-w-md mx-auto">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="login">
            ...
            <div class="flex items-center justify-between">
                ...
                <nuxt-link class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" to="/blogger/register/">
